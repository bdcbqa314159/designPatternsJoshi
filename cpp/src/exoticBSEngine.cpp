#include "../include/dpJoshi_bits/exoticBSEngine.hpp"
#include <cmath>
...
void ExoticBSEngine::GetOnePath(MJArray &SpotValues){
    ...
    for (unsigned long int j{}; j<NumberOfTimes; ++j){
...
ExoticBSEngine::ExoticBSEngine(const Wrapper<PathDependent> &TheProduct_, const Parameters &R_, const Parameters &D_, const Parameters &Vol_, const Wrapper<RandomBase> &TheGenerator_, double Spot_)
